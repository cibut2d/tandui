...
curl -sS https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
rm /etc/nginx/conf.d/vps.conf
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/newudpgw"
...
#OpenVPN
#wget https://raw.githubusercontent.com/cibut2d/tandui/main/OPENVPN/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# // install lolcat
wget https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
# install fail2ban
...
wget -q -O /etc/julak.txt "https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/julak.txt"
...
wget https://raw.githubusercontent.com/cibut2d/tandui/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O menu-theme "https://${julak}/main/menu/menu-thema.sh"
