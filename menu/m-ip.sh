...
echo -e "$COLOR1 ${NC}                ${WH}• Julak-Bantur •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/reg/main/ip | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/reg.git &> /dev/null
cd /root/reg/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch vps &> /dev/null
...
echo "### $client $exp $daftar $isadmin" >>/root/reg/ip
git add .
git commit -m register &> /dev/null
git branch -M main &> /dev/null
git remote add origin https://github.com/${USERGIT}/reg.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/reg.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 2-4 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌────────────────────── ${WH}BY${NC} ${COLOR1}───────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                ${WH}• Julak-Bantur •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
name1=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 2 | sed -n "$nombor"p) #name
exp=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
sed -i "s/### $name1 $exp $ivps1//g" /root/reg/ip &> /dev/null
...
"
echo "${TEXTD}" >>/root/reg/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/reg.git
cd /root/reg/
rm -rf .git
git init
touch vps
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/reg/ip")
...
name1=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p) #name
exp=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p) #exp
ivps1=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g" /root/reg/ip
git add .
git commit -m renew
git branch -M main
git remote add origin https://github.com/${USERGIT}/reg.git
git push -f https://${APIGIT}@github.com/${USERGIT}/reg.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• RENEW EXP IPVPS •             ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
#name1=$(grep -E "^### " "/root/julak/ipvps" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p) #name
#exp=$(grep -E "^### " "/root/julak/ipvps" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p) #exp
ivps1=$(grep -E "^### " "/root/reg/ip" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/cibut2d/reg/main/ip | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
